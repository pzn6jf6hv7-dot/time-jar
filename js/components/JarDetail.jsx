// 缃愬瓙璇︽儏椤电粍浠?const JarDetail = ({ jar, onBack, onAddTime, onDeleteRecord, onRefresh }) => {
  ...
  // 鎸夋棩鏈熷垎缁勮褰?  const groupedRecords = React.useMemo(() => {
    const groups = {};
  ...
  const handlePomodoroComplete = (minutes) => {
    onAddTime(jar.id, {
      ...
      mode: 'pomodoro',
      note: `鐣寗閽?${Math.round(minutes)}鍒嗛挓`
    });
  ...
  return (
    <div className="page relative">
      ...
      <div className="glass-card p-6 mb-6 text-center relative">
        ...
        {progress < 100 && (
          <p className="text-xs text-gray-400 mt-2">
            杩橀渶 {formatMinutes(remainingMinutes)}
          </p>
        )}
        {progress >= 100 && (
      ...
      <div className="glass-card p-5 mb-6">
        <h3 className="font-semibold text-gray-800 mb-4">璁板綍鏃堕棿</h3>
          ...
          <div className="animate-fade-in-up">
            <div className="flex gap-3 mb-3">
              <div className="flex-1">
                <label className="block text-xs text-gray-500 mb-1">灏忔椂</label>
                <input
                  type="number"
              ...
              <div className="flex-1">
                <label className="block text-xs text-gray-500 mb-1">鍒嗛挓</label>
                <input
                  type="number"
                  className="input text-center"
                  value={manualMinutes}
        ...
        {mode === 'pomodoro' && (
          <div className="animate-fade-in-up text-center py-4">
            <p className="text-gray-500 mb-4">
              寮€濮?{jar.pomodoroMinutes || 25} 鍒嗛挓鐨勪笓娉ㄦ椂闂?            </p>
            <button
      ...
      <div className="glass-card p-5">
        <h3 className="font-semibold text-gray-800 mb-4">
          ...
          <span className="text-sm text-gray-400 font-normal ml-2">
            ({jar.records.length} 鏉?
          </span>
        </h3>

        {jar.records.length === 0 ? (
          <p className="text-center text-gray-400 py-6">杩樻病鏈夎褰曪紝寮€濮嬫祰姘村惂锛?/p>
        ) : (
